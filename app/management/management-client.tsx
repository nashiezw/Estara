...
export default function ManagementClient() {
    ...
    return <main className="pm-shell"><header className="pm-hero"><div><a href="/workspace" className="pm-back">← Workspace</a><p className="pm-kicker">PROPERTY MANAGEMENT</p><h1>Rent operations, without the spreadsheet fog.</h1><p>Leases, collections, deposits and owner reporting in one tenant-safe workspace.</p></div><button className="pm-secondary" onClick={load}>Refresh</button></header>
