...
export default function MarketingStudioClient({ platform }: { platform: { shortName: string; primaryColor: string; accentColor: string } }) {
  ...
  return <main className="studio-page" style={themeVars}>
    <header className="studio-topbar">
      ...
      <details className="studio-mobile-export-menu"><summary>Export & download</summary><div><button onClick={downloadPreview}>Download to device</button><button onClick={saveExport} disabled={busy}>Save to platform</button><button onClick={sharePreview}>Share design</button></div></details>
    </header>
