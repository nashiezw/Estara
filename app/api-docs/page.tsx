...
export default async function Page() {
  ...
  return <main className="pm-shell"><PlatformToolHeader platform={brand} section="API docs" />
    <header className="pm-hero"><div><p className="pm-kicker">ESTARA CONNECT</p><h1>Build against a stable contract.</h1><p>Use bearer credentials, least-privilege scopes, idempotency keys, field maps and signed webhooks to connect websites, portals and CRMs.</p><p><a className="pm-primary" href="/api/openapi">Download OpenAPI JSON</a></p></div></header>
